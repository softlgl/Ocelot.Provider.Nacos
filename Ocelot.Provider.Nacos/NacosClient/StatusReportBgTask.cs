...
{
    public class StatusReportBgTask
    {
        ...
        private string ReplaceAddress(string address)
        {
            ...
            else if (address.ToLower().Contains("localhost"))
            {
                address = address.ToLower().Replace("localhost", ip);
            }
            else if (address.ToLower().Contains("0.0.0.0"))
            {
                address = address.ToLower().Replace("0.0.0.0", ip);
            }
